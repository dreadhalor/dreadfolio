    ...
    return (
      <div className='flex h-screen w-full items-center justify-center bg-white'>
        <div className='max-w-md rounded-lg border border-red-200 bg-red-50 p-6 text-center'>
          <h2 className='mb-2 text-xl font-semibold text-red-800'>Firebase Not Available</h2>
          <p className='mb-4 text-sm text-red-600'>
            Fallcrate requires Firebase to be configured. Please check that all Firebase environment variables are set.
          </p>
