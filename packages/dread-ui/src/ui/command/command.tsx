...
import { Dialog, DialogContent } from '@dread-ui/index';
...
>(({ className, wrapperClassName, ...props }, ref) => (
  ...
  >
    ...
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        'placeholder:text-muted-foreground flex h-10 w-full rounded-md bg-transparent py-3 text-sm outline-none data-[disabled=true]:cursor-not-allowed data-[disabled=true]:opacity-50',
        className,
      )}
      {...props}
    />
